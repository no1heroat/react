...
const ConfirmOrder = () => {
  ...
  const itemsPrice = cartItems.reduce((acc, item) => acc + item.price * item.quantity, 0); // Provide initial value 0 for acc
    ...
    <>
      ...
      <div className='row d-flex justify-content-between'>
        <div className='col-12 col-lg-8 mt-5 order-confirm cartt'>
          ...
          <p className='mb-4'>
            <b>Address:</b> {deliveryInfo.address} {/* Make sure to access the correct address field */}
          </p>
          <hr />
